...
from college_management_app.models import Course, SessionYearModel, Subjects, Staffs ,Students
...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        for course in courses:
            course_field = (course.id, course.course_name)
            course_list.append(course_field)
    except:
        course_list = []
    ...
    try:
        ...
        for sess in sessions:
            sess_field = (sess.id, str(sess.session_start_year) + "   TO  " + str(sess.session_end_year))
            session_list.append(sess_field)
    except:
        session_list = []
